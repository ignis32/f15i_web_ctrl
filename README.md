...
- In Chrome, Web Bluetooth may need to be explicitly enabled: go to `chrome://flags/#enable-web-bluetooth` and set it to **Enabled**, then relaunch Chrome
...
AI (Claude Code) had been heavily used during development of this app.
